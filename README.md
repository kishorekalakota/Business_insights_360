...
## Live Dashboard: _[Business Insights 360](https://app.powerbi.com/groups/me/reports/af6023ad-2bea-4bbc-bce2-daa04e83999b/123d946da5a9a6d8a099?experience=power-bi)_
## Home Page :


- **View objective:** 

    **1.** Created a _[Home Page](https://github.com/kishorekalakota/Business_insights_360/blob/main/Home.png)_ fro the user to navigate to different Views in the Dashboard.
...
- **Tooltips:** With the help of **Tooltips** we can identify the **icon name**, when put curser on it we can see the name of the icons belongs to their views.
...
- **View objective:** 
    ...
    **1.** Created a Dashboard for _[Finance View](https://github.com/kishorekalakota/Business_insights_360/blob/main/finance_view.png)_
...
- **View objective:** 
    ...
    **1.** Created a Dashboard for _[Sales View](https://github.com/kishorekalakota/Business_insights_360/blob/main/sales_view.png)_
...
- **View objective:** 
    ...
    **1.** Created a Dashboard for _[Marketing View](https://github.com/kishorekalakota/Business_insights_360/blob/main/marketing_view.png)_
...
- **Buttons:** Creating a buttons using **Bookmarks**, In just one click we can shift to **show NP%** to **show GM%**.

## Supply Chain View :

- **View objective:** 

    **1.** Created a Dashboard for _[Supply Chain View](https://github.com/kishorekalakota/Business_insights_360/blob/main/supply_chain_view.png)_
...
- **View objective:** 
    ...
    **1.** Created a Dashboard for _[Executive View](https://github.com/kishorekalakota/Business_insights_360/blob/main/Executive_view.png)_
